...
namespace WinForms
{
    public partial class Chn : Form
    {
        List<string> str = new List<string>();
        List<string> ti = new List<string>();
        List<string> ti2 = new List<string>();
        string[] f = System.IO.Directory.GetFiles("D:/Web/Web_Homework/Chn", "*.txt");
        public Chn()
        {
            InitializeComponent();
        }
        ...
        {
            string[] files = System.IO.Directory.GetFiles("D:/Web/Web_Homework/Chn_af", "*.txt");
            string text = "";
            string a = "";
            string line;
            int count = 0;
        ...
        {
            DirectoryInfo dir = new DirectoryInfo(@"D:\Web\WinForms\index2");
